...
- Nexus State definitions are plain shared `{ token, validation? }` objects with typed service Tokens, not a factory call. Keep the business Zustand creator in the host.
