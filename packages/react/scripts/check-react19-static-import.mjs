...
try {
  ...
  await writeFile(
    ...
    `import { NexusProvider, useNexus, useRemoteStore, useStoreStatus } from "@nexus-js/react";\n\nfor (const [name, value] of Object.entries({ NexusProvider, useNexus, useRemoteStore, useStoreStatus })) {\n  if (typeof value !== "function") {\n    throw new Error(\`Expected named export \${name} to be a function.\`);\n  }\n}\n`,
  );
