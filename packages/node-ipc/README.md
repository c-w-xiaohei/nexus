...
For the product guide, read the [Node IPC documentation](https://c-w-xiaohei.github.io/nexus/docs/node-ipc/). This package README is a short reference for installation, exports, and the minimum setup shape.
