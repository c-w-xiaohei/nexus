---
title: Testing Nexus State
description: Test Nexus State stores, subscriptions, and lifecycle behavior.
---
...
[application testing guide](/nexus/docs/testing/). This page covers the parts
