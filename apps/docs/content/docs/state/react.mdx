---
title: Nexus State React Guide
description: Use Nexus State remote stores and lifecycle controls in React.
---

This page covers the Nexus State bindings in `@nexus-js/react`. For Nexus
providers, typed React scopes, and service proxy status, see [React](/nexus/docs/react/).
