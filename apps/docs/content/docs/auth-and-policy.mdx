...
description: Configure connection and call authorization across Nexus adapters.
---
...
See [Identity and connection metadata](/nexus/docs/identity-and-metadata/) for the full field placement model and trust boundary guidance.
...
- Node IPC adapter: [Node IPC](/nexus/docs/node-ipc/)
- Core concepts: [Concepts](/nexus/docs/concepts/)
- Identity and metadata: [Identity and connection metadata](/nexus/docs/identity-and-metadata/)
