...
The main acquisition and selection failures are structured errors:
...
| `create`, `createMulticast`           | `E_SERVICE_UNAVAILABLE`         | The target was reached, but the provider was unavailable.     |
...
coupling the observer to its creator. See [service proxy lifecycle](/nexus/docs/proxy-lifecycle/)
