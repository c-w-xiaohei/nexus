...
- application code that calls `nexus.connect(...)` and gets services from connections
...
- error paths for connection or service acquisition failures
...
- connection lifecycle, collection snapshots, or identity subscriptions
