...
description: Handle Node IPC sessions, daemon restarts, and structured errors.
---
...
- old connection-bound proxies should fail
...
4. Check whether the proxy was acquired before a daemon restart.
