---
title: Service Proxy Lifecycle
description: Observe and replace session-bound Nexus service proxies.
---
...
<Callout type="warn" title="Proxies are session-bound">
  After a disconnect, recreate the proxy. A raw proxy cannot reconnect,
  retarget, retry, or replay calls for you.
</Callout>
...
// See /nexus/docs/concepts/#connectiontarget-and-where for concrete targets.
